...
export default function ThemeIntro_f({ scrollerRef }) {
  // 接收滾動容器的ref
  ...
  return (
    <>
      <div
        ref={sectionRef}
        className="relative z-50 w-full h-screen flex items-center justify-center overflow-hidden"
      >
        {/* The Founders watermark text */}
        <h1
          ref={textRef}
