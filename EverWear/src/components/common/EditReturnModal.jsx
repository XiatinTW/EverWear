...
function EditReturnModal({ show, onHide, form, onFormChange, onItemChange, onItemCheck, onShipmentChange, onSubmit, allSizes, allColors, selectedOrder }) {
    return (
        <Modal show={show} onHide={onHide} size="xl">
            <Modal.Header closeButton>
                <Modal.Title>編輯退換貨申請</Modal.Title>
            </Modal.Header>
            <Modal.Body>
                <div className="row">
                                                    ...
                                                    <td>
                                                        ...
                                                        <div className="mt-1">
                                                            ...
                                                            {item.exchange_to_size && (
                                                                <div style={{ color: 'red', fontSize: 13, marginTop: 2 }}>換貨尺寸：{item.exchange_to_size}</div>
                                                            )}
                                                        </div>
                                                    </td>
                                                    <td>
